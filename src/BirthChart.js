  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      ...
      <div className="fixed top-6 right-6 z-30 space-y-3">
        <div className="bg-white/95 backdrop-blur-xl rounded-2xl px-5 py-3 shadow-xl border border-white/20">
          <div className="flex items-center space-x-3">
            <div className="relative">
              <div className="w-3 h-3 bg-emerald-500 rounded-full animate-pulse"></div>
              <div className="absolute inset-0 w-3 h-3 bg-emerald-400 rounded-full animate-ping"></div>
            </div>
            <span className="text-slate-700 font-medium text-sm">{userCount.toLocaleString()} active users</span>
          </div>
        </div>
        
        <div className="bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-2xl px-5 py-3 shadow-xl">
          <div className="flex items-center space-x-2">
            <span className="text-lg">🏆</span>
            <span className="font-medium text-sm">94.7% Accuracy Rate</span>
          </div>
        </div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-gradient-to-r from-purple-100 to-blue-100 rounded-full px-6 py-3 mb-6">
            ...
            <span className="text-purple-800 font-semibold">Analysis Complete</span>
          </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/50 overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="flex items-center space-x-4">
                  <div className="text-5xl bg-white/20 backdrop-blur-sm p-4 rounded-2xl">
                    {getZodiacEmoji(zodiac)}
                  </div>
                  <div>
                    <h2 className="text-3xl font-bold mb-1">{name}'s Celestial Profile</h2>
                    <p className="text-purple-100 text-lg">{nakshatra} Nakshatra • {zodiac} Sign</p>
                  </div>
                </div>
                <div className="bg-white/20 backdrop-blur-sm rounded-2xl px-6 py-4">
                  <div className="text-center">
                    <p className="text-purple-100 text-sm mb-1">Cosmic Age</p>
          ...
          <div className="p-8 lg:p-12">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
              {[
                ...
                <div key={index} className="group">
                  <div className="bg-gradient-to-br from-white to-slate-50 p-6 rounded-2xl border border-slate-200 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <div className={`bg-gradient-to-r ${metric.color} w-14 h-14 rounded-2xl flex items-center justify-center text-white text-2xl mb-4 group-hover:scale-110 transition-transform`}>
                      {metric.icon}
                    </div>
            ...
            <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-8 rounded-3xl mb-8 border border-emerald-200">
              <div className="flex items-start justify-between mb-6">
                <div>
                  <h3 className="text-2xl font-bold text-slate-800 mb-2">Intellectual Aptitude Analysis</h3>
                  <p className="text-emerald-700 font-medium">Powered by Advanced Vedic Algorithms</p>
                </div>
                <div className="text-right">
                  <div className={`text-4xl font-bold ${getScoreColor(breakdown.logical || 0, 5)}`}>
                    {breakdown.logical || 0}/5
                  </div>
                  <p className="text-sm text-slate-600 mt-1">Cosmic Score</p>
                </div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl">
                <p className="text-slate-700 leading-relaxed">{personalizedInsight}</p>
              </div>
            </div>

            {/* Nakshatra Insights */}
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-8 rounded-3xl mb-10 border border-purple-200">
              <div className="flex items-center mb-6">
                <div className="bg-gradient-to-r from-purple-500 to-indigo-500 p-3 rounded-2xl mr-4">
                  <span className="text-2xl text-white">⭐</span>
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-slate-800">Nakshatra Wisdom</h3>
                  <p className="text-purple-700">Ancient Vedic Star Analysis</p>
                </div>
              </div>
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl">
            ...
            <div className="mb-12">
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-slate-800 mb-3">Unlock Complete Analysis</h3>
                <p className="text-lg text-slate-600">Discover hidden talents and personalized guidance</p>
              </div>

              <div className="grid gap-6">
                {Object.entries(hiddenInsights).map(([category, insight]) => (
                  <div key={category} className="group relative bg-gradient-to-r from-slate-50 to-white p-6 rounded-2xl border-2 border-dashed border-slate-300 hover:border-purple-400 transition-all duration-300">
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center space-x-4">
                          <div className="bg-gradient-to-r from-slate-400 to-slate-500 p-3 rounded-2xl text-white text-xl">
                            {category === 'creative' && '🎨'}
                            {category === 'sports' && '⚡'}
                          ...
                          <div>
                            ...
                            <p className="text-slate-600">Detailed analysis with remedies</p>
                          </div>
                        </div>
                        <div className="flex items-center space-x-2">
                      ...
                      <p className="text-slate-600 line-clamp-2">{insight}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Social Proof */}
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-8 rounded-3xl mb-10 border border-blue-200">
              <h3 className="text-2xl font-bold text-center text-slate-800 mb-8">Trusted by Thousands of Families</h3>
              ...
              <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-slate-700 mb-2 italic">"{testimonials[currentTestimonial].text}"</p>
            ...
            <div className="mb-12">
              <div className="text-center mb-10">
                <h3 className="text-4xl font-bold text-slate-800 mb-4">Choose Your Path to Enlightenment</h3>
                <p className="text-xl text-slate-600 mb-6">Unlock your child's complete potential</p>
                <div className="inline-flex items-center bg-gradient-to-r from-rose-500 to-orange-500 text-white px-6 py-3 rounded-full font-bold animate-pulse">
                  ⚡ LIMITED TIME: 70% OFF
                </div>
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                <div className="relative group">
                  <div className="absolute -inset-1 bg-gradient-to-r from-purple-600 to-blue-600 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 transition duration-300"></div>
                  <div className="relative bg-white p-8 rounded-3xl shadow-xl">
                    ...
                    <div className="text-center mb-8 pt-4">
                      ...
                      <h4 className="text-2xl font-bold text-slate-800 mb-2">Essential Insights</h4>
                      <p className="text-slate-600">Complete Vedic analysis</p>
                    </div>

                    <div className="text-center mb-8">
                      <div className="flex items-baseline justify-center space-x-2 mb-2">
                        <span className="text-5xl font-bold text-slate-800">₹29</span>
                        <span className="text-2xl text-slate-400 line-through">₹99</span>
                      </div>
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-2xl font-bold hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                    >
                ...
                {/* Premium Plan */}
                <div className="relative group">
                  <div className="absolute -inset-1 bg-gradient-to-r from-amber-400 to-orange-500 rounded-3xl blur-xl opacity-75 group-hover:opacity-100 transition duration-300"></div>
                  <div className="relative bg-white p-8 rounded-3xl shadow-xl">
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <span className="bg-gradient-to-r from-amber-400 to-orange-500 text-white px-6 py-2 rounded-full text-sm font-bold">
                        PREMIUM CHOICE
                      </span>
                    </div>
                    ...
                    <div className="text-center mb-8 pt-4">
                      <div className="text-5xl mb-4">👑</div>
                      <h4 className="text-2xl font-bold text-slate-800 mb-2">Complete Analysis</h4>
                      <p className="text-slate-600">Professional astrologer report</p>
                    </div>

                    <div className="text-center mb-8">
                      <div className="flex items-baseline justify-center space-x-2 mb-2">
                        <span className="text-5xl font-bold text-slate-800">₹149</span>
                        <span className="text-2xl text-slate-400 line-through">₹299</span>
                      </div>
                      <span className="text-sm text-slate-600">Includes consultation</span>
                    </div>

                    <ul className="space-y-4 mb-8">
                      <li className="font-bold text-amber-600 text-center mb-3">
                    ...
                    <button
                      ...
                      className="w-full bg-gradient-to-r from-amber-400 to-orange-500 text-white py-4 rounded-2xl font-bold hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300"
                    >
                      Get Premium Report
                    </button>
                  </div>
            ...
            <div className="text-center">
              <button
                onClick={onBack}
                className="bg-slate-600 text-white px-8 py-4 rounded-2xl hover:bg-slate-700 transition-all duration-300 font-medium"
              >
                ← Retake Assessment
              </button>
            </div>
