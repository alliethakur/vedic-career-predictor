...
function IQIntroForm({ onStart, onPictureTestStart }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 relative">
      ...
      {/* Picture Test Side Option - Much Smaller Mobile Version */}
      <div className="fixed right-1 sm:right-6 top-1/2 transform -translate-y-1/2 z-50">
        <div 
          className="bg-gradient-to-br from-pink-500 via-purple-500 to-indigo-600 rounded-lg sm:rounded-2xl shadow-lg sm:shadow-2xl p-2 sm:p-6 w-32 sm:w-auto sm:max-w-xs hover:scale-105 transition-all duration-300 cursor-pointer border sm:border-4 border-white/20" 
          onClick={handlePictureTestClick}
        >
          <div className="text-center">
            <div className="w-6 h-6 sm:w-16 sm:h-16 mx-auto mb-1 sm:mb-4 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
              <span className="text-sm sm:text-3xl">🎨</span>
            </div>
            <h3 className="text-xs sm:text-lg font-bold text-white mb-1 sm:mb-2 leading-tight">Little Explorer!</h3>
            <p className="text-white/90 text-xs sm:text-sm mb-1 sm:mb-4 leading-tight">
              <span className="font-semibold">3-7 years?</span><br className="sm:hidden" />
              <span className="hidden sm:inline"> Try our fun picture adventure!</span>
              <span className="sm:hidden"> Fun pics!</span>
            </p>
            <div className="bg-white/20 rounded-md sm:rounded-lg p-1 sm:p-3 mb-1 sm:mb-4 backdrop-blur-sm">
            ...
            <div className="bg-white text-purple-600 py-1 sm:py-2 px-2 sm:px-4 rounded-full font-semibold text-xs sm:text-sm hover:bg-purple-50 transition-colors">
              Coming Soon!
            </div>
          </div>
        </div>
